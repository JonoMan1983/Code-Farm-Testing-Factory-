...
<blockquote class="hero-quote"><p><span class="q-w">From</span> <span class="q-vec">vector-level Illustrator accuracy</span> <span class="q-w">to</span> <span class="q-ai">AI-accelerated system architecture</span><span class="q-w">—built to deliver at</span> <span class="q-epoch">epoch-shifting speed<i aria-hidden="true"></i><i aria-hidden="true"></i><i aria-hidden="true"></i></span>.</p></blockquote>
<div class="hero-meta">
