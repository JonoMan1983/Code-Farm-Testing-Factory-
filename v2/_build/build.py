...
<blockquote class="hero-quote"><p><span class="q-w">From</span> <span class="q-vec">vector-level Illustrator accuracy<svg class="q-path" viewBox="0 0 300 24" preserveAspectRatio="none" aria-hidden="true"><path d="M4 16 C 80 2, 150 26, 296 10" pathLength="1"/><line x1="4" y1="16" x2="80" y2="4"/><rect x="0" y="12" width="8" height="8"/><rect x="292" y="6" width="8" height="8"/><circle cx="80" cy="4" r="3.5"/></svg></span> <span class="q-w">to</span> <span class="q-ai">AI-accelerated system architecture</span><span class="q-w">—built to deliver at</span> <span class="q-epoch">epoch-shifting speed<i aria-hidden="true"></i><i aria-hidden="true"></i><i aria-hidden="true"></i></span>.</p></blockquote>
<div class="hero-meta">
